  ...
  return (
    ...
    <div className='flex flex-col'>
        <div className='py-10' id='start-here'>
          <h1 className='text-3xl lg:text-5xl font-semibold text-gold-600'>Portfolio</h1>
        </div>
        {/* Businesses Section */}
        <div className='flex flex-col' id='businesses'>
          ...
          <div className='flex flex-col md:flex-row justify-between py-5'>
            <div className='basis-1/2 py-5 md:mr-5'>
              <div>
                <h3 className='text-2xl font-semibold'><Link href="/synotate">Synotate</Link></h3>
        ...
        <div className='' id='projects'>
          ...
          <div className='flex flex-col md:flex-row justify-between py-5'>
            <div className='basis-1/2 md:mr-5'>
              <div>
                <h3 className='text-2xl font-semibold'><Link href="/synotate">Windows Nostalgia</Link></h3>
                <p className='pt-3'><i>Development: 2017 - 2018 <br /> Production: 2019</i></p>
              </div>
              <div className='pt-5'>
